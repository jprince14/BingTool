...
def browser_login(wrapper_class, browserobj):
    ...
    try:
        ...
        print("Error : \"%s\"" % str(bad_user.text.encode('ascii', 'ignore')))
        sys.exit(1)
    ...
    try:
        ...
        print("Error : \"%s\"" % str(password_error.text.encode('ascii', 'ignore')))
        sys.exit(2)
    except selenium.common.exceptions.TimeoutException:
    ...
    if (two_factor == True):
        ...
        verification = input("%s : " % str(page_description.text.encode('ascii', 'ignore')))
        ...
        try:
            ...
            print("Error : \"%s\"" % str(proof_error.text.encode('ascii', 'ignore')))
            sys.exit(3)
        except selenium.common.exceptions.TimeoutException:
        ...
        otc_code = input("%s : " % str(title_elem.text.encode('ascii', 'ignore')))
        ...
        try:
            ...
            print("Error : \"%s\"" % str(otc_error.text.encode('ascii', 'ignore')))
            sys.exit(4)
        except selenium.common.exceptions.TimeoutException:
            # The proof confirmation was correct
            pass
